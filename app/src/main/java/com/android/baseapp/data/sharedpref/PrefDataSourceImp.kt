...
import com.android.baseapp.util.Constants.FOUR_HOURS_IN_MILLI_SECONDS
...
class PrefDataSourceImp(private val context: Context) : PrefDataSource {
    ...
    object Constants {
        ...
        const val CACHING_TIME = "caching_time"
    }
    ...
    override fun getCachingTime(): Long {
        return getLongPreference(Constants.CACHING_TIME, FOUR_HOURS_IN_MILLI_SECONDS)
    }

    override fun setCachingTime(cachingTime: Long) {
        setLongPreference(Constants.CACHING_TIME, cachingTime)
    }
